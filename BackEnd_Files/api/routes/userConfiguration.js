...
router.get("/:userid", getUserConfiguration); //get user personal details by appid (/PersonalDetails/:appid)
router.get("/", getAllUsersConfiguration);
router.post("/:userid", createUserConfiguration); //post (/PersonalDetails/)
router.delete("/:userid", deleteUserConfiguration); //delete user personal details (/PersonalDetails/:appid)
