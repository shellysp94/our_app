    ...
    (err, rows) => {
      try {
        if (err || rows === undefined) {
          ...
          let first_name = capitalizeFirstLetter(req.body.first_name);
          let last_name = capitalizeFirstLetter(req.body.last_name);
          ...
          let city = capitalizeFirstLetter(req.body.city);
          ...
          let profession = capitalizeFirstLetter(req.body.profession);
