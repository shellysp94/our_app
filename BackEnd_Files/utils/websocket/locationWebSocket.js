const {insertUserLocation, updateUserLocation} = require("../../api/controllers/userLocation");
...
function updateLocation(onlineUsers,message,ws) 
{
	...
	if(user_id != -1)
	{
		...
		{
			params: {userid: parseInt(user_id), longitude: parseFloat(longitude), latitude:parseFloat(latitude)},
		};
