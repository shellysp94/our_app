...
CREATE TABLE Filters (
  ...
  interesting_in_filter set('Interesting in', 'Friends','Hookup', 'Long term relationship', 'Short term relationship', 'Sport buddy', 'Study buddy', 'Work buddy') default 'Interesting in',
  age_filter JSON,
