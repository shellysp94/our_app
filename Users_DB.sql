...
CREATE TABLE user_configuration (
  ...
  relationship_status enum('Divorced', 'Engaged', 'In a relationship', 'In an open relationship', 'Married', 'Single' , 'Widowed') default null,
  ...
  hobbies set('basketball', 'beach volleyball', 'crossfit', 'dancing', 'football/soccer', 'gym workout', 'hiking', 'pilates', 'running', 'slacklining', 'surfing', 'swimming', 'tennis', 'yoga',
  ...
  'camping', 'gardening', 'sailing', 'skippering', 'shopping', 'tanning', 'traveling') default null,
  radius int,
 ...
 CREATE TABLE Filters (
  ...
  hobbies_filter set('basketball', 'beach volleyball', 'crossfit', 'dancing', 'football/soccer', 'gym workout', 'hiking', 'pilates', 'running', 'slacklining', 'surfing', 'swimming', 'tennis', 'yoga',
  'baking', 'cooking', 'eating outside', 'interested in culinary', 'interesting in nutrition',
  'playing drums', 'playing guitar', 'playing in a band', 'playing piano', 'playing synthesizer', 'singing',
  'acting', 'fashion designing', 'handicraft', 'home decorating', 'juggling', 'painting',
  'blogging', 'interested in medicine and biology', 'learning new languages', 'listening to podcasts', 'playing chess', 'puzzling', 'reading', 'writing',
  'coding', 'hacking', 'playing video games',
  'camping', 'gardening', 'sailing', 'skippering', 'shopping', 'tanning', 'traveling') default null,
  gender_filter set('Men', 'Women', 'All') default null,
  relationship_filter set('Divorced', 'Engaged', 'In a relationship', 'In an open relationship', 'Married', 'Single' , 'Widowed') default null,
  interesting_in_filter set('Friends','Hookup', 'Long term relationship', 'Short term relationship', 'Sport buddy', 'Study buddy', 'Work buddy') default null,
  age_filter JSON default null,
